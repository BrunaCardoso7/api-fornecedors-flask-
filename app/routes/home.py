...
@routes_bp.route('/salvar_fornecedor', methods=['POST'])
...
# Adicionar o novo fornecedor ao banco de dados
        ...
        db.session.commit()
        return redirect(url_for('routes.fornecedores'))
@routes_bp.route('/search_fornecedor')
def render_search_fornecedor():
...
@routes_bp.route('/encontra_produto')
def render_encontra_produto():
